...
- Validate that minimum is at least 1, maximum is at most 100, and minimum is less than or equal to maximum.
...
## Verification
- Test ranges 1-6, 1-20, 1-100, and per-die mixed ranges.
